class Messages:
    ...
    def no_publication() -> str:
        return (
            "К сожалению, публикаций для выбранного языка пока нет. Я уже созваниваюсь с разработчиками, "
            "чтобы это исправить 🥺"
        )
    ...
    def ask_language() -> str:
        return (
            "Значительная часть публикаций написана на английском языке. Вы владеете им и готовы обрабатывать "
            "такие публикации?\n\n"
    ...
    def invalid_characters() -> str:
        return (
            "В ответе содержатся недопустимые символы, пожалуйста, используйте только буквы русского и латинского"
            " алфавита и цифры 🚫"
        )
    ...
    def message_not_only_digits() -> str:
        return (
            "Возможно, вы промахнулись, когда писали цифру, но в вашем сообщении есть другие символы "
            "🙄\nПопробуйте ещё раз"
        )
    ...
    def started_unidentified_action() -> str:
        return (
            "Вы начали и не закончили какое-то другое действие. Завершите это действие, пожалуйста, или отмените "
    ...
    def unavailable_during_registration() -> str:
        return (
            "Простите, но по техническим причинам не могу вам дать воспользоваться данной командой на этапе "
            "регистрации. 😔\n\n"
