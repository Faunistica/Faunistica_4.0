...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('OCCURRENCE', sa.String(10), nullable=True, server_default='OCCURRENCE'),
        ...
        sa.Column('IDENTIFICATION', sa.String(15), nullable=True, server_default='IDENTIFICATION'),
