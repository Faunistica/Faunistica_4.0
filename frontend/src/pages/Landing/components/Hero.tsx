                ...
                <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-8">
                    <div className="flex flex-col justify-center space-y-8">
                        <div className="space-y-4">
                            ...
                            <p className="max-w-[600px] leading-relaxed text-muted-foreground md:text-xl">
                        ...
                        <div className="flex flex-col gap-4 sm:flex-row">
                            <Button
                                ...
                                size="lg"
                                className="h-12 gap-2 bg-primary px-8 text-base text-primary-foreground hover:bg-primary/90"
                            >
                            ...
                            <Button
                                size="lg"
                                variant="outline"
                                className="h-12 border-border bg-background px-8 text-base text-foreground hover:bg-accent"
                            >
                                Узнать больше
                            </Button>
                        </div>
                    </div>
                    <div className="relative mx-auto aspect-square w-full max-w-[500px] overflow-hidden rounded-2xl border border-border shadow-2xl lg:aspect-4/3 lg:max-w-none">
                        <img
                        ...
                        />
                        <div className="absolute inset-0 flex flex-col justify-end bg-linear-to-t from-foreground/60 to-transparent p-6 md:p-8">
