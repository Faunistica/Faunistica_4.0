...
export default function Science() {
    return (
        <section id="science" className="w-full bg-background py-16 md:py-24">
            <div className="mx-auto w-full max-w-7xl px-4 md:px-6">
                ...
                <div className="mx-auto max-w-4xl rounded-2xl border border-border bg-muted p-6 shadow-sm md:p-10">
                    <div className="flex flex-col gap-8 md:flex-row">
                        <div className="flex shrink-0 items-start justify-center md:pt-2">
                            <div className="rounded-full border border-border bg-card p-4 shadow-sm">
                                <Microscope className="size-10 text-foreground" />
                            </div>
                        </div>
                            ...
                            <div className="flex flex-wrap gap-4 pt-4">
                                <div className="flex w-full items-center gap-3 rounded-lg border border-border bg-card px-4 py-3 sm:w-auto">
