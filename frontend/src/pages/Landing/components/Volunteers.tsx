...
export default function Volunteers() {
    return (
        <section id="volunteers" className="w-full bg-slate-900 py-16 text-slate-50 dark:bg-card md:py-24">
            <div className="mx-auto w-full max-w-7xl px-4 md:px-6">
                <div className="grid items-center gap-12 lg:grid-cols-2">
                    <div className="space-y-6">
                        ...
                        <div className="grid gap-4 pt-4 sm:grid-cols-2">
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <h4 className="font-semibold text-white dark:text-foreground">Рейтинг и сувениры</h4>
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <h4 className="font-semibold text-white dark:text-foreground">Сообщество</h4>
                                    <p className="text-sm text-slate-400">
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <h4 className="font-semibold text-white dark:text-foreground">Терапия фобий</h4>
                                    <p className="text-sm text-slate-400">
                        ...
                        <div className="pt-6">
                            <Button className="w-full bg-white font-semibold text-slate-900 hover:bg-slate-100 dark:bg-foreground dark:text-background dark:hover:bg-foreground/90 sm:w-auto">
                    ...
                    <div className="relative">
                        <Card className="relative z-10 border-slate-700 bg-slate-800 shadow-2xl dark:border-border dark:bg-muted">
                            <CardHeader>
                                <CardTitle className="text-xl text-white dark:text-foreground">
                                    Студентам и школьникам
                                </CardTitle>
                            </CardHeader>
                                <CardContent className="space-y-4 text-slate-300 dark:text-muted-foreground">
                                <p>
                                ...
                                <div className="flex items-center gap-4 rounded-lg border border-slate-700 bg-slate-900/50 p-4 dark:border-border dark:bg-card/50">
                        ...
                        <div className="absolute -right-6 -bottom-6 -z-10 size-full rounded-xl bg-slate-700 opacity-50 blur-sm dark:bg-muted"></div>
                    </div>
                </div>
            </div>
        </section>
