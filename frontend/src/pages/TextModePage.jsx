...
const TextModePage = () => {
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      if (
        result.count_males ||
        result.count_females ||
        result.count_juv_male ||
        result.count_juv_female ||
        result.count_juv
      ) {
      ...
      setFormState((prev) => {
        ...
        if (result.date != null && !pinnedSections["material_collection"])
          updates.begin_date = result.date;
        if (result.biotope != null && !pinnedSections["material_collection"])
          updates.biotope = result.biotope;
        if (result.collector != null && !pinnedSections["material_collection"])
          updates.collector = result.collector;
        if (result.country != null && !pinnedSections["administrative"])
          updates.country = result.country;
        if (result.region != null && !pinnedSections["administrative"])
          updates.region = result.region;
        if (result.district != null && !pinnedSections["administrative"])
