...
const FormSidebar: FC = () => {
  ...
  }, [activeRecordId, recordIds, isMobile]);
  ...
  return (
    <>
      <Sidebar variant="sidebar" className="border-r border-slate-200">
          ...
          <div className="flex items-center justify-between">
            {isMobile ? (
              <div className="flex items-center gap-2">
                ...
                <div>
                  <div className="text-sm/tight font-bold text-slate-900">Менеджер</div>
        ...
        <SidebarContent>
          <SidebarGroup className="overflow-y-hidden p-0">
            ...
            <SidebarGroupContent ref={scrollRef} className="no-scrollbar overflow-y-scroll p-2">
      ...
      <ExcelUploadModal open={isUploadOpen} onOpenChange={setIsUploadOpen} publ_id={publ_id} />
    </>
  );
};
