        ...
        <SidebarMenuItem>
            <NavLink
                ...
                className={cn(
                    ...
                    isActive ? 'bg-accent shadow-sm ring-1 ring-border' : 'hover:bg-accent',
                )}
            >
                <div className="flex min-w-0 items-center gap-2 pb-1">
                    <RecordStatusIndicator status={status} />
                    <span className="truncate text-xs/tight font-bold text-foreground">
                        {recordName}
                    </span>
                </div>

                <div className="flex w-full items-center gap-1.5 pl-0.5 text-[10px] text-muted-foreground">
                    {isActive ? (
                        <>
            ...
            <AlertDialog>
                <AlertDialogTrigger asChild>
                    <Button
                        ...
                        variant="ghost"
                        size="icon"
                        className="absolute top-2.5 right-1.5 z-10 size-6 shrink-0 rounded-md text-muted-foreground opacity-100 transition-opacity group-hover/menu-item:opacity-100 hover:bg-red-100 hover:text-red-600 aria-expanded:opacity-100 dark:hover:bg-red-950 md:opacity-0"
